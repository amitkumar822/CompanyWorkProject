    ...
    <div>
      <div>
        ...
        <div className="w-full mx-auto m-10">
          ...
          <div className="md:min-w-[400px] lg:w-[40%] sm:w-[320px] w-[370px] mx-auto border p-4 bg-gradient-to-r from-cyan-500 to-blue-500 to-[#bbe0bb] rounded-lg shadow-lg shadow-[#c78c5c]">
            ...
            <form className="w-full mx-auto">
              ...
              <div className="w-[90%] mx-auto">
                ...
                <div className="flex mt-2 gap-2 justify-center items-center">
                  <h1 className='md:text-[16px] text-[14px]'>You already have an account?</h1> <Link to="/businesslogin"><h2 className="rounded-lg px-2 py-1 font-bold md:text-[#f44646] md:text-[16px] text-[14px]">Login Now</h2></Link>
                </div>
              </div>
            </form>
          </div>
