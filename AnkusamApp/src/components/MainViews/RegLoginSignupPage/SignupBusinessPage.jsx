          ...
          <div className="md:min-w-[400px] lg:w-[40%] sm:w-[350px] w-[370px] mx-auto border p-4 bg-gradient-to-r from-cyan-500 to-blue-500 md:to-[#bbe0bb] rounded-lg shadow-lg shadow-[#c78c5c]">
            ...
            <form className="w-full mx-auto">
              ...
              <div className="w-[90%] mx-auto">
                <div className="flex gap-2 items-center my-2">
                  ...
                  <h1>
                    ...
                    <span className="text-[red] cursor-pointer">
                      <button type="button" onClick={openDialog}>Terms and Conditions</button>
                ...
                <button className="w-full mx-auto bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:bg-gradient-to-l to-pink-8  00 py-2 rounded-lg font-bold text-lg text-white ">
                  Sign Up
                </button>
