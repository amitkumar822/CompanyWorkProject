          ...
          <div className="md:min-w-[400px] lg:w-[40%] sm:w-[320px] w-[370px] mx-auto border p-4 bg-gradient-to-r from-cyan-500 to-blue-500 md:to-[#bbe0bb] rounded-lg shadow-lg shadow-[#c78c5c]">
            ...
            onSubmit={handleSubmit}
             className="w-full mx-auto">
              ...
              <div className="w-[90%] mx-auto">
                ...
                <button className="w-full mx-auto bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:bg-gradient-to-l to-pink-8  00 py-2 rounded-lg font-bold text-lg text-white cursor-pointer">
                  Login Now
                </button>
              </div>
            </form>
            <div className="flex mt-2 gap-2 justify-center items-center">
              ...
              <Link to="/businesssignup">
                <span className="rounded-lg px-2 py-1 font-bold text-[#f44646]">
                  Sign Up
                </span>
              </Link>
            </div>
